...
/**
 * AES-GCM encrypted message framing over a byte stream. Ported verbatim from
 * `desktop/shared/.../crypto/SecureChannel.kt` - frame shape must match
 * exactly, since the Mac decodes what Android encodes and vice versa.
 *
