...
internal fun ToolsTab(
    ...
    Column(
        ...
        ToolRow(
            ...
            subtitle = if (isRefreshing) stringResource(R.string.tools_fetch_missing_busy)
                else stringResource(R.string.tools_fetch_missing_subtitle),
        ...
        ToolRow(
            ...
            subtitle = if (duplicateCount == 0) stringResource(R.string.tools_duplicates_none)
                else pluralStringResource(R.plurals.tools_duplicates_subtitle, duplicateCount, duplicateCount),
        ...
        ToolRow(
            ...
            subtitle = if (trashCount == 0) stringResource(R.string.tools_trash_empty)
                else pluralStringResource(R.plurals.tools_trash_subtitle, trashCount, trashCount),
            onClick = onOpenTrash,
            enabled = trashCount > 0,
            trailingAction = if (trashCount > 0) stringResource(R.string.action_empty_trash) else null,
            onTrailingAction = onEmptyTrash,
        )
